              ...
              <div className="uc-navbar-left">
                <div className="uc-logo text-dark dark:text-white">
                  <Link
                    ...
                    href={`/`}
                    style={{ width: 170, "display": "flex", "flexDirection": "row", alignItems: "center" }}
                  >
                    <Image
                      ...
                      height="40"
                    />
                    <span style={{ "fontSize": "1rem", "lineHeight": "1.25rem", "fontWeight": 700, marginLeft: "5px" }} className="text-bold">Vivid Vision</span>
                  </Link>
                </div>
