          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 xl:h1 m-0">
                Our services  for your need
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                At Vivid Vision, we take pride in offering a comprehensive range of solar services that harness the power of the sun to transform your life. With a commitment to sustainability and innovation, we aim to bring reliable, eco-friendly, and cost-effective solar solutions to our valued customers across Sri Lanka.
              </p>
            </div>
